...
HEADERS := utils.h cuda_functions.h
...
cuda_functions.o: cuda_functions.cu $(HEADERS)
	$(NVCC) $(INCLUDES) $(NVCCFLAGS) -o $@ -c $<

conv_layer4.o: conv_layer4.c $(HEADERS)
	$(GCC) $(INCLUDES) -o $@ -c $<

utils.o: utils.c $(HEADERS)
	$(GCC) $(INCLUDES) -o $@ -c $<

cnn: conv_layer4.o utils.o cuda_functions.o
	$(NVCC) -o $@ $+ $(LIBRARIES)
...
clean:
	rm -f cnn conv_layer4.o utils.o cuda_functions.o
